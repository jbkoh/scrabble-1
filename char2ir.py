...
# TODO: Implement below
    def char2ir_onestep(self,
        ...
        target_srcids = list(label_dict.keys())
        cand_srcids = [srcid for srcid in target_srcids \
        ...
        if 'next_learning_srcids' not in next_step_data:
            next_step_data['next_learning_srcids'] = deepcopy(learning_srcids)
    ...
    def query_active_learning_samples_deprecated(self,
