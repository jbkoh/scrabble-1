...
class Ir2Tagsets(object):
    ...
    def query_active_learning_samples(self, 
        ...
        learning_srcids = [] # as target_srcids are strictly defined
        (target_sentence_dict,
        target_token_label_dict,
        _,
        crf_truths_dict, 
        _) = self.get_building_data(self.target_building, target_srcids)
...
#        'pred_certainty_dict': pred_certainty_dict,
    ...
    def ir2tagset_onestep(self,
        ...
        self.target_phrase_dict = crf_phrase_dict
        learning_srcids = step_data['learning_srcids']
        self.learning_srcids = step_data['learning_srcids']
        ...
        self.target_pred_tagsets_dict = crf_pred_tagsets_dict
